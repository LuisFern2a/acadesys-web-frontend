  ...
  const handleRegisterSubmit = async (e) => {
    ...
    try {
      const nuevoUsuarioPayload = {
        ...
        rol: nombreRol,
        Perfil: nombreRol,
        IdAcademia: 1 // Semilla multi-tenant inicial
      };
  ...
  return (
    <div className="relative min-h-screen bg-slate-950 text-slate-100 overflow-hidden font-sans select-none">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-24 flex flex-col items-center text-center">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 text-left mb-16" id="modulos">
          <div className="p-6 rounded-3xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-xl hover:border-indigo-500/40 transition duration-200 group">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Administración por perfiles (Administrador, Docente, Alumno y Tutor de Aula) con sincronización fluida y aislamiento multi-tenant.
            </p>
          </div>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 text-left mt-10" id="seguridad">
          <div className="p-8 rounded-3xl bg-slate-900/40 border border-slate-800/60 backdrop-blur-md flex flex-col justify-between">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-blue-500/10 text-blue-400 text-xs font-semibold mb-4">
                <Shield className="w-3.5 h-3.5" /> Seguridad Avanzada
              </div>
              <h3 className="text-xl font-bold text-white mb-3">Protección de Datos y Tokens JWT</h3>
              <p className="text-slate-400 text-xs sm:text-sm leading-relaxed mb-6">
                Cada inicio de sesión genera un token cifrado con el ID de la academia para asegurar el aislamiento de datos, evitando modificaciones de notas no autorizadas.
              </p>
            </div>
            <ul className="space-y-2.5 text-xs text-slate-300">
              <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Autenticación basada en tokens JWT</li>
              <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Control de permisos por roles específicos</li>
              <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Encriptación de claves y datos sensibles</li>
            </ul>
          </div>

          <div className="p-8 rounded-3xl bg-slate-900/40 border border-slate-800/60 backdrop-blur-md flex flex-col justify-between" id="institucional">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-indigo-500/10 text-indigo-400 text-xs font-semibold mb-4">
                <Building2 className="w-3.5 h-3.5" /> Entorno Escolar
              </div>
              <h3 className="text-xl font-bold text-white mb-3">Gestión Académica Completa</h3>
              <p className="text-slate-400 text-xs sm:text-sm leading-relaxed mb-6">
                Diseñado para cubrir las necesidades de directores, docentes, alumnos y tutores de aula en una sola interfaz fluida, rápida y moderna.
              </p>
            </div>
            <ul className="space-y-2.5 text-xs text-slate-300">
              <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-indigo-400" /> Registro y control de asistencia diario</li>
              <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-indigo-400" /> Cuaderno de notas bimestrales</li>
              <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-indigo-400" /> Canal de comunicados y circulares</li>
            </ul>
          </div>
        </div>
      </main>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="3">Tutor de Aula (Supervisión y Finanzas)</option>
                      <option value="4">Alumno / Estudiante (Boleta y Tutor IA)</option>
                    </select>
                  </div>
                </div>
